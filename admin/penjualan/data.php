        ...
        <tbody>
            <?php foreach ($querytampil as $tampil => $data) { ?>
                <tr>
                    ...
                    <td>
                        <a href="edit.php?penjualan=<?= $data['id_penjualan'] ?>">Edit</a>
                        <a href="proseshapus.php?penjualan=<?= $data['id_penjualan'] ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')">Hapus</a>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
